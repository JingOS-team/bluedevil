...
Bluetooth module of plasma-settings for JingOS.
...
* The Bluetooth that the application handles follow the [ical](https://tools.ietf.org/html/rfc5545) standard.
...
* Project page: https://github.com/JingOS-team/bluedevil

* Issues: https://github.com/JingOS-team/bluedevil/issues
...
To build Bluetooth from source on Linux, execute the below commands.
...
```
/bin/plasma-settings -m bluetooth
```
